      ...
      <div className="lg:pl-60">
        <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
            <div>
              <p className="text-sm font-semibold text-slate-900">Ürün geliştirme</p>
              <p className="text-xs text-slate-500">28 Eylül · teslim planı</p>
            </div>
          ...
          <nav className="flex gap-1 overflow-x-auto border-t border-slate-100 bg-[#18212f] px-4 py-2 lg:hidden">
            <NavigationLinks />
          </nav>
        </header>
